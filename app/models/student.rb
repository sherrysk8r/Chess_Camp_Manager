class Student < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :registrations, reject_if: lambda { |registration| registration[:camp_id].blank? || registration[:payment_status].blank?}, allow_destroy: true
